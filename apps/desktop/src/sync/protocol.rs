...
pub(crate) struct HybridTimestamp {
...
pub(crate) type VectorClock = BTreeMap<String, u64>;
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub(crate) struct ProtocolDocument {
    pub version: u32,
    pub protocol: String,
}
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub(crate) struct DeviceBookEntry {
    pub book_id: String,
    pub present: bool,
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub(crate) struct DeviceLibrary {
    pub version: u32,
    pub device_id: String,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub(crate) struct DeviceBookState {
    pub version: u32,
    pub device_id: String,
    pub book_id: String,
    pub updated_at: HybridTimestamp,
...
pub(crate) fn compare_clocks(left: &VectorClock, right: &VectorClock) -> ClockOrder {
